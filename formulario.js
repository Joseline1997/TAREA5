...
const validarFormulario = (e) => {
	switch (e.target.name) {
		...
		break;
        case "usuario2":
			validarCampo(expresiones.usuario2, e.target, 'usuario2');
		break;
		case "nombre":
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.usuario2 && campos.nombre  && campos.password && campos.correo && campos.telefono  && campos.telefono2 && terminos.checked ){
		formulario.reset();
